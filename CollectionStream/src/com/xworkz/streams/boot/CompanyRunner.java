...
public class CompanyRunner {
	...
	public static void main(String[] args) {
		...
		ceoDtos.stream().map(dto -> dto.getDaughterDto()).collect(Collectors.toList())
				.forEach(dto -> System.out.println(dto.getName()));

		System.out.println(" ");

		ceoDtos.stream().collect(Collectors.toList()).forEach(dto -> System.out.println(dto));
		System.out.println(" ");

		ceoDtos.stream().filter(dto -> dto.getAge() > 70).collect(Collectors.toList())
				.forEach(dto -> System.out.println(dto));
		System.out.println(" ");
		ceoDtos.stream().forEach(dto -> System.out
				.println("father age : " + dto.getAge() + " & " + "daughter age : " + dto.getDaughterDto().getAge()));
