...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"
				...
				src="https://images.livemint.com/img/2021/10/04/600x338/FA0tl6BVgAYPfZr_1633360605983_1633360630121.jpg"
	...
	<form action="aeroplane" method="post">
		...
		</select> Select Country <select class="form-select"
