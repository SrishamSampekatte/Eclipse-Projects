...
<body>
	...
	<form action="trimmerRegistration" method="post">
		<div class="mb-3">
		...
		</select> <br>Select Charging Time <select class="form-select"
			aria-label="Default select example" name="chargingTime"
			required="required">
			<option selected value="">Select Charging Time</option>
			<c:forEach items="${charge}" var="c">
				<option value="${c}">${c}</option>
			</c:forEach>
		</select><br>
