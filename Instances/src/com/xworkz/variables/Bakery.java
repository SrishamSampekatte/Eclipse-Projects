...
public class Bakery {
	...
	public Bakery (String name,String tray,int noOfVeg,String favtVeg,boolean healthy,String[] Veg,double[] nums,String[] color,String[] vitamins,double[] price,String[] dryFruits)
	{
		this.name=name;
		this.tray=tray;
