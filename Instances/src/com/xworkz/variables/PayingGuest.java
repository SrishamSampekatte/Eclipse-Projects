...
public class PayingGuest {
	...
	public PayingGuest(String name,int noOfRooms, int noOfSharing,String ownerName,boolean worth,String[]BreakFast,String[]Lunch,String[]Dinner,String[]Facilities,String[]Roomies,String[]Catagory)
	{
		this.name=name;
